...
public class Product implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5002969706151471495L;
	private int id;
	private String name;
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", productCatgeory=" + productCatgeory + ", manufactureDate="
				+ manufactureDate + ", price=" + price + "Shipping details: " + details + "]";
	}
	...
	//method to link shipment details to a product
