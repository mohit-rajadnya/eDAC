...
create table students ( student_no varchar(25), surname varchar(25), forename varchar(25));
create table modules ( module_code varchar(25), module_name varchar(25));
create table marks ( student_no varchar(25), module_code varchar(25), mark integer);
